...
private val LightColorScheme =
  lightColorScheme(
    ...
    secondary = NovaLightSecondary,
    tertiary = NovaLightAccent,
...
fun MyApplicationTheme(
  ...
  NovaHomeTheme(darkTheme = darkTheme, dynamicColor = dynamicColor, content = content)
}
